...
class Test(Base):
    ...
    def update(self):
        ...
        # if triangle passes off-screen on the right, change the translation so it reappears on the left
        if self.translation.data[0] > 1.2:  # accounts for triangle width
            self.translation.data[0] = -1.2
            self.baseColor.data[2] += .1
