...
class Test(Base):
    ...
    def screen_recorder(self, file_name):
        ...
        pygame.image.save(screen_surf, f"../skull_anim/{file_name}.jpg")
    ...
    def update(self):
        ...
        if self.angle == self.iter0 * pi/1000:
            ...
            self.hex_tile1(phi = self.angle, color = ORANGE, pr = RADIUS * 1 / 5) 
            self.hex_tile1(phi = 0, color = ORANGE, pr = RADIUS * 1/5)
